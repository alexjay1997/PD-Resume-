...
$check="SELECT * FROM user WHERE username = '$_POST[username]'";
...
$search_text = $_POST['search_text'];
 ...
 $query = "SELECT * FROM `user` WHERE CONCAT(`id`,`fname`,`lname`,`username`, `password`, `email`) LIKE '%".$search_text."%'";
...
<div class="header" style="background:#bf59bf;overflow:hidden;">
	<div class="logo" style="width:55%;padding:20px;margin:0px auto;">
		<h2 style="font-family:calibri;text-align:center;color:white;padding-left:px;"> Registration </h2>
...
<div class="register" id="registration" style="box-shadow: 0px 0px 0px 1d1d1d;background:#fffff;width:20%; border:1px solid #eee;margin:0 auto;justify-content:center;align-items:center;display:flex;position:relative;top:40px;padding:30px;">


<form action="" method="post" style="border;"> 
<h2 style="font-family:calibri;text-align:center;color:violet;">Signup</h2><br>
...
<button type="submit" name="save" style="cursor:pointer;width:100%;padding:10px;background-color:#2da2d8;border:none;color:#ffffff;">Submit</button>
...
<br>
<center>
	<a href="index.php" style="text-decoration:none;background:#6ed46e;color:#ffffff;padding:8px;">Cancel</a></center>
